defmodule SalactivErpWeb.Router do
  use SalactivErpWeb, :router

  import SalactivErpWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {SalactivErpWeb.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: SalactivErpWeb.Telemetry
    end
  end
